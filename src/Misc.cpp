...
void lidar_tester(unsigned long print_period) {
    auto& robot = GET_ROBOT();
...
constexpr uint8_t STRIPE_BOT_Y = SCREEN_H - 6 - STRIPE_H;
...
bool in_triangle(int dx, int dy, int inset) {
