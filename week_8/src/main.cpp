...
mtrn3100::IMUGyroscope gyroscope{};
mtrn3100::Lidar lidar1(LIDARFRONT_EN_PIN, 0x54);
//lidar1 is front

mtrn3100::Lidar lidar2(LIDARLEFT_EN_PIN, 0x55);
//lidar2 is left

mtrn3100::Lidar lidar3(LIDARRIGHT_EN_PIN, 0x56);
//lidar3 is right
